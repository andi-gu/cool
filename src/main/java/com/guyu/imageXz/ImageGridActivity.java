...
import com.guyu.imageXz.ImageGridAdapter.TextCallback;
...
public class ImageGridActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dataList = (List<ImageItem>) getIntent().getSerializableExtra(
				EXTRA_IMAGE_LIST);
		tvBackGrid = (TextView) findViewById(R.id.tv_back_imageGrid);
		tvBackGrid.setOnClickListener(new OnClickListener() {
